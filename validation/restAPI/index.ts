...
import sendPromptValidate from "@validation/restAPI/gemini/sendPrompt";
import createNoteValidate from "@validation/restAPI/gemini/createNote";
import completeNoteValidate from "@validation/restAPI/gemini/completeNote";
import createQuestionValidate from "@validation/restAPI/gemini/createQuestion";
...
export const validations = {
    ...
    gemini: {
        send: sendPromptValidate,
        createNote: createNoteValidate,
        completeNote: completeNoteValidate,
        createQuestion: createQuestionValidate,
    },
};
