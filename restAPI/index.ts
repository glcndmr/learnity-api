...
import sendPrompt from "./domains/gemini/sendPrompt";
import createNote from "./domains/gemini/createNote";
import completeNote from "./domains/gemini/completeNote";
import createQuestion from "./domains/gemini/createQuetion";
...
export const endpoints: EndpointGroup = {
    ...
    gemini: {
        send: { handler: sendPrompt, method: "POST", auth: true },
        createNote: { handler: createNote, method: "POST", auth: true },
        completeNote: { handler: completeNote, method: "POST", auth: true },
        createQuestion: { handler: createQuestion, method: "POST", auth: true },
    }
};
